...
{
  "overview": "A concise 1-2 sentence description of what the project is and its core purpose.",
  "keyFeatures": [
    "Feature 1 title & brief description",
    "Feature 2 title & brief description",
    "Feature 3 title & brief description",
    "Feature 4 title & brief description"
  ],
  "techStack": {
...
Return valid JSON ONLY matching the schema.`;
    ...
    const userPrompt = `Project Title: "${cleanTitle}"\nKey Points / Context: "${cleanPoints || 'Build a software application'}"${reqContextStr}`;
